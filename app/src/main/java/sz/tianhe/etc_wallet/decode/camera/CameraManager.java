...
package sz.tianhe.etc_wallet.decode.camera;
...
import sz.tianhe.etc_wallet.decode.camera.open.OpenCamera;
import sz.tianhe.etc_wallet.decode.camera.open.OpenCameraInterface;
...
//    Rect rect = getFramingRectInPreview();//获取聚焦矩形
//    if (rect == null) {
//      return null;
//    }
    //去掉聚焦数据 使用一张图片作为解析
